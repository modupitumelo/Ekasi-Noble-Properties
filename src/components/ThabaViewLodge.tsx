    ...
    <section id="thaba-view" className="py-20 bg-gradient-to-b from-green-50 to-white">
      ...
      {selectedImage !== null && (
        <div className="fixed inset-0 bg-black bg-opacity-95 z-50 flex items-center justify-center p-4 sm:p-6">
          ...
          >
            <ChevronLeft size={28} className="sm:w-8 sm:h-8 text-gray-800 hover:text-green-600" />
          </button>
          ...
          >
            <ChevronRight size={28} className="sm:w-8 sm:h-8 text-gray-800 hover:text-green-600" />
          </button>
          ...
          <div className="relative max-w-6xl w-full flex flex-col items-center">
            ...
            <div className="flex md:hidden gap-3 sm:gap-4 justify-center mt-4">
              <button
                className="bg-white/90 backdrop-blur-sm rounded-full p-2.5 sm:p-3 text-gray-800 hover:text-green-600 hover:bg-white transition-all shadow-lg"
                onClick={handlePrevImage}
                aria-label="Previous image"
              >
